...
const Footer = () => {
    return (
     ...
     <div className="mt-10 bg-gradient-to-r from-red-100 to-blue-100 w-[95%] mx-auto">
<footer className="footer p-10   text-base-content ">
  <aside>
    <img  className="w-28 rounded-full" src={'https://i.ibb.co/XSHzcJ4/download.png'} alt="" />
    <p>Find job  Ltd.<br/>Providing reliable tech since 1992</p>
  </aside> 
  <nav>
...
<p className="text-center p-4">Copyright © 2023 - All right reserved by Find Job Ltd</p>
     </div>
